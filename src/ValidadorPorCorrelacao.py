    ...
    for n in tipo_erro:
        ...
        for i in range(1, n_sensores + 1):
            ...
            for j in range(1, n_sensores + 1):
                if i!=j:
                    proximo_sensor = pd.read_csv(f'/home/kathiani/midval/dados/{tiposensor}/{lote}/{n}-{tiposensor}{j}.csv')
            ...
            best_sensor_data = pd.read_csv(f'/home/kathiani/midval/dados/{tiposensor}/{lote}/{n}-{tiposensor}{best_sensor_id}.csv')
